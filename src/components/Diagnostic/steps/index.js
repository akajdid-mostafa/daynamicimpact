...
export default function Steps() {
  ...
  const validateStep = () => {
    ...
    if (step === 1) {
      ...
      } else if (!phoneRegex.test(form.companyPhone.replace(/\s/g, ""))) {
      ...
      // Validation de l'année de création (maintenant required)
      if (!form.yearCreation) {
        newErrors.yearCreation = "L'année de création est requise";
      ...
      // Validation de la ville (maintenant required)
      ...
      <div className={cn("container", styles.container)}>
        <div className={styles.formWrapper}>
          ...
          <form className={styles.form} onSubmit={(e) => e.preventDefault()}>
            ...
            {/* باقي الخطوات تبقى كما هي بدون تغيير */}
            ...
            {step === 2 && (
              <div className={styles.step}>
                ...
                <label className={styles.label}>
                  8. Disposez-vous d'une structure organisationnelle formelle et
                ...
                <label className={styles.label}>
                  9. Les décisions sont-elles prises au sein de l'entreprise sur
                ...
                <label className={styles.label}>
                  10. Existe-t-il des mécanismes de contrôle interne et de suivi
                  de la performance ? *
                  <select
                    className={cn(styles.select, {
                ...
                <label className={styles.label}>
                  11. Principaux défis organisationnels auxquels votre
                  entreprise est confrontée aujourd'hui :
            ...
            {step === 3 && (
              <div className={styles.step}>
                ...
                <label className={styles.label}>
                  12. Comment décrivez-vous votre situation financière actuelle
                  ? *
                  <select
                    className={cn(styles.select, {
                ...
                <label className={styles.label}>
                  13. Disposez-vous d'une étude financière ou d'un plan de
                  financement clair ? *
                  <div className={styles.radioGroup}>
                    <label className={styles.radioLabel}>
                      <input
                ...
                <label className={styles.label}>
                  14. Votre entreprise a-t-elle des dettes ou des engagements
                  élevés ? *
                  <select
                    className={cn(styles.select, {
                ...
                <label className={styles.label}>
                  15. Comment décrivez-vous la relation avec les banques ou les
                  investisseurs ? *
                  <select
                    className={cn(styles.select, {
            ...
            {step === 4 && (
              <div className={styles.step}>
                ...
                <label className={styles.label}>
                  16. Votre entreprise rencontre-t-elle des problèmes de flux de
                ...
                <label className={styles.label}>
                  17. Avez-vous déjà constaté du désordre, des détournements de
                ...
                <label className={styles.label}>
                  18. Quel est le niveau de dépendance de votre entreprise à
                ...
                <label className={styles.label}>
                  19. L'entreprise a-t-elle un plan clair de développement de la
            ...
            {step === 5 && (
              <div className={styles.step}>
                ...
                <label className={styles.label}>
                  20. Choisissez la phrase la plus proche de la réalité de votre
                ...
                <label className={styles.label}>
                  21. Quel est l'objectif principal que vous poursuivez
                  aujourd'hui ? *
                  <div
            ...
            {step === 6 && (
              <div className={styles.step}>
                ...
                <div className={styles.reviewSection}>
                  ...
                  <p>
                    <strong>Année de création:</strong> {form.yearCreation}
                  </p>
                  <p>
      ...
      <div className={styles.modalContent}>
        <div className={styles.resultHeader}>
          ...
          <div className={styles.resultImageContainer}>
            {result.category === "Solide" && (
              <img src="/images/diagnostic/green.webp" alt="Solide" className={styles.resultImage} />
            )}
            {result.category === "À améliorer" && (
              <img src="/images/diagnostic/yellow.webp" alt="À améliorer" className={styles.resultImage} />
            )}
            {result.category === "À risque" && (
              <img src="/images/diagnostic/orange.webp" alt="À risque" className={styles.resultImage} />
            )}
            {result.category === "Fragile" && (
              <img src="/images/diagnostic/red.webp" alt="Fragile" className={styles.resultImage} />
            )}
          </div>

          <div className={cn(styles.scoreContainer, styles[result.color])}>
        ...
        <div className={styles.resultDetails}>
          <p className={styles.classification}>
            Votre entreprise est classée au niveau :{" "}
            <strong style={{
              color: result.color === "green" ? "#34b759" :
                     result.color === "yellow" ? "#ffd02c" :
                     result.color === "orange" ? "#ff8b2c" : "#e81f1f"
            }}>
              {result.category}
            </strong>
            .<br />

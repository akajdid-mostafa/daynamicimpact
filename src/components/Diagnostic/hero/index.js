          ...
          <div className={cn("container", styles.container)}>
            <div className={styles.content}>
              ...
              <div className={styles.introDesc}>
                <p>Recevez un diagnostic gratuit révélant vos forces, vos leviers de croissance et les priorités à améliorer.</p>
                <p className={styles.arabicText}>أحصل على تقرير مجاني يكشف نقاط القوة، محركات النمو، ومجالات التحسين داخل شركتك</p>
              </div>

              <div className={styles.languageSelector}>
                <h3 className={styles.languageTitle}>Choisissez votre langue pour commencer</h3>
              ...
              <div className={styles.ctaSection}>
                ...
                <div className={styles.additionalText}>
                  <p className={styles.frSmall}>
                    Vos réponses restent strictement confidentielles et protégées conformément à nos engagements et à la réglementation en vigueur (RGPD)
                  </p>
                  <p className={styles.arSmall}>
                    إجاباتك تبقى سرية ومحمية تماماً وفقاً لالتزاماتنا واللوائح المعمول بها
                  </p>
                </div>
              </div>
            </div>
